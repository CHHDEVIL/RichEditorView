...
public class RichEditorView extends WebView {
    ...
    /**
     * @return 获取删除Html标签后的文字
     */
    public String getRemoveHtmlTagText() {
        if (mContents == null) {
            return null;
        }
        // 含html标签的字符串
        String htmlStr = mContents;
        String textStr = "";
    ...
    /**
     * {@link RichEditorView#insertImage(String, String)} will show the original size of the image.
